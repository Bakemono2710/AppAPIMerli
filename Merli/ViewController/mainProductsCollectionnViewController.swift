...
// Variable global que refrencia a TODOS los productos que se descargaron
...
class mainProductsCollectionnViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UITextFieldDelegate {
    ...
    {
        let alert = UIAlertController(title: "MercadoLibre", message:"Opción no implementada.", preferredStyle:.alert)
    ...
    func searchProducts(_ text:String)
    {
        ...
        let urlString =
            "https://api.mercadolibre.com/sites/MLA/search?q=" + encodedText
          /*"https://api.mercadolibre.com/sites/MLA/search?q=Motorola%20G6"*/
          /*"htt ps://www.hackingwithswift.com/samples/petitions-1.json"*/
      
        // Descarga del JSON con los productos.
    ...
    func parse(json:Data) {
        ...
        if let jsonData = try? decoder.decode(Products.self, from: json) {
            productsJSON = jsonData.results
     ...
     iOS swift collection load images asynchronically
      ...
      func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            let registro = productsJSON[indexPath.row]
            ...
            // Descargo la imagen.
            guard let picURL = URL(string: registro.thumbnail) else { return cell }
